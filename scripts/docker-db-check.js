...
console.log("\n📈 Counts:");
for (const t of ["item", "player", "villager", "\"transfer\"", "transfer_line_item", "crafting", "crafting_line_item", , "anvil", "anvil_line_item", "smelting", "smelting_line_item", "mining", "mining_line_item"]) {
