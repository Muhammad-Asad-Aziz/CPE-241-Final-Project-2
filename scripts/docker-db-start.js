...
async function main() {
  ...
  console.log("\n✅ Database started. Host: localhost:15432 | DB: craftless_db | User: root");
  console.log("   Adminer (web UI): http://localhost:8080 — Server: pgdatabase | User: root | Password: root | Database: craftless_db");
}
